  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Your donation helps Virgo Building Society deliver training, mentorship, and affordable support to registered groups and community initiatives."
      />
      <Container className="py-12 md:py-16">
        <div className="rounded-3xl border border-black/10 bg-white p-6 md:p-8">
          <h2 className="text-lg font-semibold">How to donate</h2>
          <p className="mt-2 text-sm text-mutedInk">
            Use any of the options below. After donating, you can WhatsApp us a screenshot for confirmation.
          </p>
