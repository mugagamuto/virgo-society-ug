...
function Toggle({ checked, onChange }: { checked: boolean; onChange: (v: boolean) => void }) {
  return (
    ...
    >
      <span
        className={
          "h-7 w-7 rounded-full bg-white shadow transition " + (checked ? "translate-x-7" : "translate-x-0")
        }
      />
    </button>
  );
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-mutedInk">
                Edit the 3 homepage cards (title, subtitle, image path, link, order). Use local images like{" "}
                <span className="font-medium text-black">/photos/children.jpg</span>
              </p>
            </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <Input
                        ...
                        placeholder="/photos/children.jpg"
                      />
                    </div>
                    <div className="mt-2 text-xs text-mutedInk">
                      Tip: open the image like <span className="font-medium text-black">/photos/children.jpg</span>
                    </div>
                  </div>
